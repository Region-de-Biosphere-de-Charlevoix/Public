"use strict";
(self["webpackChunkexb_client"] = self["webpackChunkexb_client"] || []).push([["node_modules_arcgis_map-components_dist_components_arcgis-measurement_customElement_js"],{
...
/***/ "./node_modules/@arcgis/map-components/dist/components/arcgis-measurement/customElement.js":
/*!*************************************************************************************************!*\
  !*** ./node_modules/@arcgis/map-components/dist/components/arcgis-measurement/customElement.js ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ArcgisMeasurement: () => (/* binding */ h)
/* harmony export */ });
...
/* harmony import */ var _arcgis_core_widgets_Measurement_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @arcgis/core/widgets/Measurement.js */ "@arcgis/core/widgets/Measurement.js");
...
See https://js.arcgis.com/4.32/esri/copyright.txt for details.
v4.32.1 */
const c = (0,_lit_reactive_element_css_tag_js__WEBPACK_IMPORTED_MODULE_5__.css)`@layer{arcgis-measurement{display:block}}`, l = (0,_chunks_useWidget_js__WEBPACK_IMPORTED_MODULE_4__.m)(_arcgis_core_widgets_Measurement_js__WEBPACK_IMPORTED_MODULE_2__["default"]);
class h extends _arcgis_lumina__WEBPACK_IMPORTED_MODULE_3__.LitElement {
  constructor() {
    super(...arguments), this.widget = l(this), this.viewModel = this.widget.viewModel, this.activeTool = this.widget.activeTool, this.activeWidget = this.widget.activeWidget, this.areaUnit = this.widget.areaUnit, this.autoDestroyDisabled = !1, this.icon = this.widget.icon, this.label = this.widget.label, this.linearUnit = this.widget.linearUnit, this.position = "bottom-left", this.state = this.viewModel.state, this.arcgisPropertyChange = (0,_arcgis_components_controllers__WEBPACK_IMPORTED_MODULE_1__.usePropertyChange)()("activeTool", "state"), this.arcgisReady = (0,_arcgis_lumina__WEBPACK_IMPORTED_MODULE_3__.createEvent)();
  }
  static {
...
(0,_chunks_runtime_js__WEBPACK_IMPORTED_MODULE_0__.c)("arcgis-measurement", h);
