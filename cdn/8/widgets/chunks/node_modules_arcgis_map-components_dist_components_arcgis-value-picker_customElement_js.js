"use strict";
(self["webpackChunkexb_client"] = self["webpackChunkexb_client"] || []).push([["node_modules_arcgis_map-components_dist_components_arcgis-value-picker_customElement_js"],{
...
/***/ "./node_modules/@arcgis/map-components/dist/components/arcgis-value-picker/customElement.js":
/*!**************************************************************************************************!*\
  !*** ./node_modules/@arcgis/map-components/dist/components/arcgis-value-picker/customElement.js ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ArcgisValuePicker: () => (/* binding */ u)
/* harmony export */ });
...
/* harmony import */ var _arcgis_core_widgets_ValuePicker_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @arcgis/core/widgets/ValuePicker.js */ "@arcgis/core/widgets/ValuePicker.js");
...
See https://js.arcgis.com/4.32/esri/copyright.txt for details.
v4.32.1 */
const l = (0,_lit_reactive_element_css_tag_js__WEBPACK_IMPORTED_MODULE_6__.css)`@layer{arcgis-value-picker{display:block}}`, c = (0,_chunks_useWidget_js__WEBPACK_IMPORTED_MODULE_5__.m)(_arcgis_core_widgets_ValuePicker_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
class u extends _arcgis_lumina__WEBPACK_IMPORTED_MODULE_4__.LitElement {
  constructor() {
    super(...arguments), this.widget = c(this), this.autoDestroyDisabled = !1, this.canNext = this.widget.canNext, this.canPlay = this.widget.canPlay, this.canPrevious = this.widget.canPrevious, this.caption = this.widget.caption, this.component = this.widget.component, this.hideNextButton = this.widget.visibleElements.nextButton, this.hidePlayButton = this.widget.visibleElements.playButton, this.hidePreviousButton = this.widget.visibleElements.previousButton, this.icon = this.widget.icon, this.label = this.widget.label, this.layout = this.widget.layout, this.loop = this.widget.loop, this.playRate = this.widget.playRate, this.position = "bottom-left", this.values = this.widget.values, this.arcgisAnimate = (0,_arcgis_components_controllers_accessor__WEBPACK_IMPORTED_MODULE_2__.reEmitEvent)(() => this.widget, "animate"), this.arcgisNext = (0,_arcgis_components_controllers_accessor__WEBPACK_IMPORTED_MODULE_2__.reEmitEvent)(() => this.widget, "next"), this.arcgisPause = (0,_arcgis_components_controllers_accessor__WEBPACK_IMPORTED_MODULE_2__.reEmitEvent)(() => this.widget, "pause"), this.arcgisPlay = (0,_arcgis_components_controllers_accessor__WEBPACK_IMPORTED_MODULE_2__.reEmitEvent)(() => this.widget, "play"), this.arcgisPrevious = (0,_arcgis_components_controllers_accessor__WEBPACK_IMPORTED_MODULE_2__.reEmitEvent)(() => this.widget, "previous"), this.arcgisPropertyChange = (0,_arcgis_components_controllers__WEBPACK_IMPORTED_MODULE_1__.usePropertyChange)()("values"), this.arcgisReady = (0,_arcgis_lumina__WEBPACK_IMPORTED_MODULE_4__.createEvent)();
  }
  static {
...
(0,_chunks_runtime_js__WEBPACK_IMPORTED_MODULE_0__.c)("arcgis-value-picker", u);
