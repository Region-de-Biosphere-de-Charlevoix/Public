"use strict";
(self["webpackChunkexb_client"] = self["webpackChunkexb_client"] || []).push([["node_modules_arcgis_map-components_dist_components_arcgis-feature-templates_customElement_js"],{
...
/***/ "./node_modules/@arcgis/map-components/dist/components/arcgis-feature-templates/customElement.js":
/*!*******************************************************************************************************!*\
  !*** ./node_modules/@arcgis/map-components/dist/components/arcgis-feature-templates/customElement.js ***!
  \*******************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ArcgisFeatureTemplates: () => (/* binding */ d)
/* harmony export */ });
...
/* harmony import */ var _arcgis_core_widgets_FeatureTemplates_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @arcgis/core/widgets/FeatureTemplates.js */ "@arcgis/core/widgets/FeatureTemplates.js");
...
See https://js.arcgis.com/4.32/esri/copyright.txt for details.
v4.32.1 */
const n = (0,_lit_reactive_element_css_tag_js__WEBPACK_IMPORTED_MODULE_6__.css)`@layer{arcgis-feature-templates{display:block}}`, c = (0,_chunks_useWidget_js__WEBPACK_IMPORTED_MODULE_5__.m)(_arcgis_core_widgets_FeatureTemplates_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
class d extends _arcgis_lumina__WEBPACK_IMPORTED_MODULE_4__.LitElement {
  constructor() {
    super(...arguments), this.widget = c(this), this.viewModel = this.widget.viewModel, this.autoDestroyDisabled = !1, this.enableListScroll = this.widget.enableListScroll, this.filterFunction = this.widget.filterFunction, this.filterText = this.widget.filterText, this.groupBy = this.widget.groupBy, this.headingLevel = this.widget.headingLevel, this.hideFilter = this.widget.visibleElements.filter, this.icon = this.widget.icon, this.label = this.widget.label, this.layers = this.widget.layers, this.position = "bottom-left", this.selectionMode = this.widget.selectionMode, this.state = this.viewModel.state, this.arcgisPropertyChange = (0,_arcgis_components_controllers__WEBPACK_IMPORTED_MODULE_1__.usePropertyChange)()("state"), this.arcgisReady = (0,_arcgis_lumina__WEBPACK_IMPORTED_MODULE_4__.createEvent)(), this.arcgisSelect = (0,_arcgis_components_controllers_accessor__WEBPACK_IMPORTED_MODULE_2__.reEmitEvent)(() => this.widget, "select");
  }
  static {
...
(0,_chunks_runtime_js__WEBPACK_IMPORTED_MODULE_0__.c)("arcgis-feature-templates", d);
